...
from app.services.user.data_service import DataService
from app.services.user.profile_service import ProfileService
from app.services.user.registration_service import RegistrationService
from app.services.user.therapist_service import TherapistService
...
class UserService:
    ...
    async def search_verified_therapists(
        ...
        return await self.therapist.search_verified_therapists(
            location, specialization, radius
        )
