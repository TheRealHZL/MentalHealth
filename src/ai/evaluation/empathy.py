...
class EmpathyEvaluator:
    ...
    def evaluate_empathy(self, text: str, context: str = "") -> Dict[str, float]:
        ...
        emotion_awareness = self._evaluate_emotion_awareness(
    ...
    def _evaluate_emotion_awareness(self, text_lower: str, context_lower: str) -> float:
        ...
        if context_lower:
            context_emotions = [
                e for e in self.emotion_recognition_keywords if e in context_lower
            ]
        ...
        total_awareness = min(
            emotion_recognition_score + context_emotion_bonus + complex_emotion_score,
            1.0,
        )
    ...
    def evaluate_empathy_progression(
        ...
        support_consistency = 1.0 - (
            max(supportiveness_scores) - min(supportiveness_scores)
        )
        ...
        return {
            ...
            "avg_supportiveness": sum(supportiveness_scores)
            / len(supportiveness_scores),
        }
    ...
    def get_empathy_recommendations(
        ...
        if evaluation_results["detractor_penalty"] > 0.3:
            ...
            recommendations.append(
                "Avoid solution-focused responses without validation"
            )
