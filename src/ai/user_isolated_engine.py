    ...
    async def generate_user_response(
        ...
        try:
            ...
            await self.save_conversation_message(
                ...
                session_id,
                message_type='user',
                encrypted_message={'content': user_message},  # Should be encrypted by client
            ...
            await self.save_conversation_message(
                ...
                encrypted_message={'content': response['response']},  # Should be encrypted
    ...
    async def analyze_user_dream(
        ...
        try:
            ...
            emotion_analysis = await self.base_engine.predict_emotion(
                text=dream_text,
                context={'type': 'dream', **(dream_metadata or {})}
            )
    ...
    def _apply_user_preferences(self, preferences: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return {
            ...
            'temperature': formality_temp.get(
                preferences.get('formality_level', 'friendly'),
                0.7
            ),
