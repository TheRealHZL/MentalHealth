...
MULTILINGUAL_SAMPLES = {
    'sentiment': {
        'de': [
            {"text": "Ich fühle mich heute großartig! Das Leben ist wunderbar.", "label": 2},
            {"text": "Mir geht es schlecht und ich fühle mich hoffnungslos.", "label": 0},
        ...
        'fr': [
            {"text": "Je me sens incroyable aujourd'hui! La vie est merveilleuse.", "label": 2},
    ...
    'emotion': {
        'de': [
            {"text": "Ich bin so aufgeregt über diese Gelegenheit!", "emotion": 0},  # joy
            {"text": "Ich fühle mich so traurig und einsam.", "emotion": 1},  # sadness
            {"text": "Ich bin wütend über das, was passiert ist!", "emotion": 2},  # anger
        ...
        'fr': [
            {"text": "Je suis tellement enthousiaste à propos de cette opportunité!", "emotion": 0},
...
def create_multilingual_data(
    ...
    for dataset_type in dataset_types:
        ...
        for lang in languages:
            ...
            tagged_samples = [
                {**sample, 'language': lang} for sample in samples
            ]
        ...
        logger.info(f"   ✓ {dataset_type}: {len(combined_train)} train, {len(combined_val)} val, {len(combined_test)} test")
