...
from src.api.v1.endpoints import (admin, ai, ai_training, analytics, auth,
                                  dreams, feedback, mood, thoughts)
...
api_router.include_router(
    ai_training.router, prefix="/ai/training", tags=["ai-training"]
)
